...
// esto crea un un mensaje para evitar valores nulos
if (nombre_tipo_gestion.trim() == ""){
  const alertError = `
  <div class="alert alert-danger" role="alert">
  El nombre de la gestion no puede estar vacío.
...
fetch("http://144.126.210.74:8080/api/gestion", requestOptions)
  .then((response) => {
    ...
    La gestion fue agregada Correctamente!! Redireccionando....:
...
.then((response) => {
  if(response.status == 200) {
    const alertaSucces = `
    <div class="alert alert-primary" role="alert">
    La gestion fue actualizado Correctamente!! Redireccionando....:
...
.then((response) => {
  if(response.status == 200) {
    const alertaSucces = `
    <div class="alert alert-primary" role="alert">
    La gestion fue eliminado Correctamente!!:
